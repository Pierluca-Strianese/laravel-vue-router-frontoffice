...
<template>
  <h1 class="text-secondary border-bottom border-secondary p-2 m-5"><font-awesome-icon :icon="['fas', 'paper-plane']" />
    Contact us </h1>
  <section class="container-sm bg-body-secondary p-4 my-5 rounded col-6">
